...
class resultClass:
  def __init__(self,root):
    ...
    lb1_marks_ob=Label(self.root,text="Marks Obtained",font=("goudy old style",20,'bold'),bg='white').place(x=50,y=280)
    ...
    btn_search=Button(self.root,text='Search',font=("goudy old text",15,'bold'),bg="#03a9f4",fg="white",cursor="hand2",command=self.search).place(x=500,y=100,width=120,height=28)
