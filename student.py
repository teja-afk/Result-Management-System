...
class studentClass:
  def __init__(self,root):
    ...
    lb1_admission=Label(self.root,text="Admission",font=("goudy old style",15,'bold'),bg='white').place(x=360,y=140)
    ...
    self.txt_address=Text(self.root,textvariable=self.var_description,font=("goudy old style",15,'bold'),bg='lightyellow')
    ...
    lb1_search_roll=Label(self.root,text="Course Name",font=("goudy old style",15,'bold'),bg='white').place(x=720,y=60)
...
#===============================================================#
  ...
  def get_data(self, ev):
    ...
    self.txt_address.delete("1.0",END)
    self.txt_address.inser(END,row[11])
